...
function giveFitness(){
  var randomNumber = Math.floor(Math.random() * fitnessLinks.length);
  var link = fitnessLinks[randomNumber];
  console.log(link);
  $('#thisdiv').load(document.URL +  ' #thisdiv');
  document.getElementById("123").src = link;
...
fetch('https://api.spotify.com/v1/recommendations?limit='+number+'&seed_genres='+genre+'&min_acousticness='+minAco+'&max_acousticness='+maxAco+'&min_danceability='+minDan+'&max_danceability='+maxDan+'&min_energy='+minEner+'&max_energy='+maxEner+'&min_popularity='+minPop+'&max_popularity='+maxPop,
{
  headers:{
    ...
    'Authorization': 'Bearer BQCducmNdj6bBG-7TCxJgvG8OOfUkIp_IaCmHi8EafFt2yFR-tiKODiznJn8gJjAFaJacG3ZbK3lE1KcdZEIi3vGeznFpABcE-cz-YbE8a1LS0Uw5ummTy4Bg4NpYizQV83jONx10_iayfz3bZz88E_SnJ_eTp6SFV3jHJGNUmN-GUBYGS9nK2ugicRHvPrLiw'
  },
  method: "GET"
})  .then((response) => {
